...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="pt-24 pb-12 bg-blue-600 text-white rounded-t-[4rem] md:rounded-t-[6rem]">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-5xl md:text-8xl font-serif italic mb-6">Let’s Make It Happen</h2>
        ...
        <div className="grid md:grid-cols-3 gap-12 text-left border-t border-blue-400/30 pt-16">
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-blue-200 mb-6">Follow Me</h4>
            <div className="flex gap-6">
              <a href="#" className="hover:text-blue-200 transition-colors"><Linkedin size={24} /></a>
              <a href="#" className="hover:text-blue-200 transition-colors"><Github size={24} /></a>
              <a href="#" className="hover:text-blue-200 transition-colors"><Globe size={24} /></a>
            </div>
          </div>
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-blue-200 mb-6">Location</h4>
            <p className="text-blue-50 font-medium">Digital Nomad / Remote</p>
            <p className="text-blue-200 text-sm">Working with clients worldwide</p>
          </div>
          <div className="text-right hidden md:block">
            <p className="text-blue-200 text-sm mb-2">Ready to start a project?</p>
